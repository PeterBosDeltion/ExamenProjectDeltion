...
namespace Pinwheel.Griffin.SplineTool
{
    ...
    public class GPathPainter : GSplineModifier
    {
        ...
        private void ApplyAlbedoAndMetallic(GStylizedTerrain t, List<Vector4> worldPoints)
        {
            ...
            t.TerrainData.Shading.Internal_AlbedoMap.ReadPixels(new Rect(0, 0, albedoResolution, albedoResolution), 0, 0);
            ...
            t.TerrainData.Shading.Internal_MetallicMap.ReadPixels(new Rect(0, 0, metallicResolution, metallicResolution), 0, 0);
        ...
        {
            GCommon.CopyToRT(t.TerrainData.Shading.Internal_AlbedoMap, rtAlbedo);
            Material mat = GInternalMaterials.PathPainterMaterial;
            mat.SetTexture("_MainTex", t.TerrainData.Shading.Internal_AlbedoMap);
        ...
        {
            GCommon.CopyToRT(t.TerrainData.Shading.Internal_MetallicMap, rtMetallic);
            Material mat = GInternalMaterials.PathPainterMaterial;
            mat.SetTexture("_MainTex", t.TerrainData.Shading.Internal_MetallicMap);
            mat.SetFloat("_Metallic", Metallic);
            mat.SetFloat("_Smoothness", Smoothness);
            mat.SetTexture("_FalloffNoise", FalloffNoise);
            mat.SetTextureScale("_FalloffNoise", new Vector2(
