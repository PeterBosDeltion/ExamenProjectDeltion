...
namespace Pinwheel.Griffin.StampTool
{
    ...
    public class GTextureStamper : MonoBehaviour
    {
        ...
        private void ApplyAlbedoMetallicSmoothness(GStylizedTerrain t)
        {
            ...
            t.TerrainData.Shading.Internal_AlbedoMap.ReadPixels(new Rect(0, 0, albedoMapResolution, albedoMapResolution), 0, 0);
            t.TerrainData.Shading.Internal_AlbedoMap.Apply();
            RenderTexture.active = null;

            RenderTexture.active = metallicRt;
            t.TerrainData.Shading.Internal_MetallicMap.ReadPixels(new Rect(0, 0, metallicMapResolution, metallicMapResolution), 0, 0);
        ...
        public void Internal_ApplyAlbedoMetallicSmoothness(GStylizedTerrain t, RenderTexture albedoRt, RenderTexture metallicRt)
        {
            ...
            Texture2D albedoMap = t.TerrainData.Shading.Internal_AlbedoMap;
            ...
            Texture2D metallicMap = t.TerrainData.Shading.Internal_MetallicMap;
