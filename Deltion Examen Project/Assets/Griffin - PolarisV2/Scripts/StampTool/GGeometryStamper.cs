...
namespace Pinwheel.Griffin.StampTool
{
    ...
    public class GGeometryStamper : MonoBehaviour
    {
        ...
        private void Apply(GStylizedTerrain t)
        {
            ...
            t.TerrainData.Geometry.Internal_HeightMap.ReadPixels(new Rect(0, 0, heightMapResolution, heightMapResolution), 0, 0);
            t.TerrainData.Geometry.Internal_HeightMap.Apply();
            RenderTexture.active = null;
            Color[] newHeightMapColors = t.TerrainData.Geometry.Internal_HeightMap.GetPixels();
        ...
        {
            GCommon.CopyToRT(t.TerrainData.Geometry.Internal_HeightMap, rt);
            ...
            mat.SetTexture("_HeightMap", t.TerrainData.Geometry.Internal_HeightMap);
