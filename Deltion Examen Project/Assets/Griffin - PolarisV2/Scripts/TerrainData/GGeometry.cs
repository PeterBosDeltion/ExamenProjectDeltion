...
namespace Pinwheel.Griffin
{
    public class GGeometry : ScriptableObject
    {
        ...
        public Texture2D Internal_HeightMap
        {
            get
            {
                if (heightMap == null)
                {
                    ...
                    GCommon.AddObjectToAsset(heightMap, TerrainData);
                }
        ...
        {
            Reset();
            GCommon.FillTexture(Internal_HeightMap, Color.clear);
        ...
        internal void Internal_CreateNewSubDivisionMap()
        {
            ...
            Graphics.Blit(Internal_HeightMap, rt, mat);
