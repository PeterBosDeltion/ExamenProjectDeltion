...
{
    [CreateAssetMenu(menuName = "Griffin/Terrain Data")]
        ...
        public GGeometry Geometry
        {
            get
            {
                if (geometry == null)
                {
                    ...
                    GCommon.AddObjectToAsset(geometry, this);
                }
        ...
        public GShading Shading
        {
            get
            {
                if (shading == null)
                {
                    ...
                    GCommon.AddObjectToAsset(shading, this);
                }
        ...
        public GRendering Rendering
        {
            get
            {
                if (rendering == null)
                {
                    ...
                    GCommon.AddObjectToAsset(rendering, this);
                }
        ...
        public GFoliage Foliage
        {
            get
            {
                if (foliage == null)
                {
                    ...
                    GCommon.AddObjectToAsset(foliage, this);
                }
