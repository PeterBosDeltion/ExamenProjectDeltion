...
namespace Pinwheel.Griffin
{
    ...
    public class GGrassPatch
    {
        ...
        public GGrassPatch(GFoliage owner, int indexX, int indexY)
        {
            foliage = owner;
        ...
        public void StripInstances(int prototypeIndex)
        {
            if (Foliage.Grasses == null)
                return;
            int count = 0;
