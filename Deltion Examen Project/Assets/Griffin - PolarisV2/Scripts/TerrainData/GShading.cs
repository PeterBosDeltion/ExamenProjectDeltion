...
namespace Pinwheel.Griffin
{
    public class GShading : ScriptableObject
    {
        ...
        public Color[,] GetAlbedo(int startX, int startZ, int sampleWidth, int sampleLength)
        {
            return GCommon.GetPixels2D(Internal_AlbedoMap, startX, startZ, sampleWidth, sampleLength, Color.clear);
        }

        public void GetAlbedoNonAlloc(int startX, int startZ, Color[,] sample)
        {
            GCommon.GetPixels2DNonAlloc(Internal_AlbedoMap, startX, startZ, sample, Color.clear);
        }

        public void SetAlbedo(int startX, int startZ, Color[,] sample)
        {
            GCommon.SetPixels2D(Internal_AlbedoMap, startX, startZ, sample);
            Internal_AlbedoMap.Apply();
            UpdateMaterials();
        }
        ...
        public Texture2D Internal_GetSplatControl(int index)
        {
            ...
            else
            {
                ...
                if (t == null)
                {
                    t = GCommon.CreateTexture(SplatControlResolution, Color.clear);
