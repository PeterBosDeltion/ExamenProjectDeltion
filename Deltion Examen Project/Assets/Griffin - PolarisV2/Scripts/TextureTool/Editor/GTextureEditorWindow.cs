...
namespace Pinwheel.Griffin.TextureTool
{
    public class GTextureEditorWindow : GTwoPaneWindowWindow
    {
        ...
        [MenuItem("Window/Griffin/Tools/Texture Creator")]
        ...
        private void OnBeginCameraRender(Camera cam)
        {
            ...
            else if (livePreviewParam.Mode == GLivePreviewMode.Geometry)
            {
                ...
                livePreviewMaterialProperties.SetTexture("_OldHeightMap", t.TerrainData.Geometry.Internal_HeightMap);
            ...
            GTerrainChunk[] chunks = livePreviewParam.Terrain.Internal_GetChunks();
