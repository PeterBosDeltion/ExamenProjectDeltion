...
namespace Pinwheel.Griffin
{
    public class GTwoPaneWindowWindow : EditorWindow
    {
        ...
        {
            Color separatorColor = EditorGUIUtility.isProSkin ? Color.black : GEditorCommon.midGrey;
            GEditorCommon.DrawLine(
                new Vector2(RightPaneRect.min.x, RightPaneRect.min.y),
                new Vector2(RightPaneRect.min.x, RightPaneRect.max.y),
                separatorColor);
