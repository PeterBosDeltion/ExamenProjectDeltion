...
namespace Pinwheel.Griffin
{
    ...
    public class GTerrainChunk : MonoBehaviour
    {
        ...
        private List<Color> generatedVertexColors;
        private List<Color> GeneratedVertexColors
        {
            get
            {
                ...
                {
                    generatedVertexColors = new List<Color>();
                }
        ...
        internal void Internal_CreateSubDivTree()
        {
            ...
            for (int i = 0; i < Terrain.TerrainData.Geometry.MeshBaseResolution; ++i)
            {
                subDivTree.ForEachLeaf(n =>
                {
                    n.Split();
        ...
        private void CreatePolygons(GSubDivisionTree tree)
        {
            ...
            tree.ForEachLeaf((n) =>
            {
                ...
                //Vector4 h1 = Vector4.zero;
                //Vector4 h2 = Vector4.zero;
        ...
        public IEnumerable<Vector2> FlattenSubDivTree()
        {
            ...
            if (!GCommon.IsMainThread && subDivTree==null)
            {
                Internal_CreateSubDivTree();
            }
