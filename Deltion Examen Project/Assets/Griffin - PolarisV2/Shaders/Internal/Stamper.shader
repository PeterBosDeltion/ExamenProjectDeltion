Shader "Hidden/Griffin/Stamper"
{
	...
	fixed4 fragStampElevation (v2f i) : SV_Target
    {
		...
		float currentHeight = heightMapColor.r;
		...
		float additionalResolution = isHeightChanged*_AdditionalMeshResolution + (1-isHeightChanged)*heightMapColor.g;

		return saturate(float4(h, additionalResolution, heightMapColor.b, heightMapColor.a));
	}
